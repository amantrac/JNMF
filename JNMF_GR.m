...
function [W, Hs, Hu, ObjHistory] = JNMF_GR(Xs, Xu, A, k, alpha, beta, lambda, epsilon, maxiter, verbose)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Joint Non-negative Matrix Factorization with Graph Regularization (JNMF_GR)
% 
